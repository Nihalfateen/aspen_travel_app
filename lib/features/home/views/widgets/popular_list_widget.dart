...
import '../../domain/model/popular_items_model.dart';
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                 onTap: (){GoRouter.of(context).pushNamed(InnerDetailsScreen.route,extra: PopularItemsModel(name: place.name, image: place.image, rate: place.rate));},
                child: Padding(
